...
- runtime - содержит все необходимые файлы, включая два файла основной программы и монитора. Сделано для удобства. Для изменения можно поправить файл CMakeLists.txt в корне проекта и подпроекта монитор. 
