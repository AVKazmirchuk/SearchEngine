...
исходном коде - [boost/assert/source_location](https://www.boost.org/doc/libs/latest/libs/assert/doc/html/assert.html#Source Location Support, <boost/assert/source_location.hpp>).
