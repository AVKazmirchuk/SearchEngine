...
Программа была разработана и протестирована на С++ версии 17. Целевые ОС использования MS Windows 10, MS Windows 11. Программа использует следующие библиотеки:
