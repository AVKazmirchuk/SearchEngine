...
Класс выбрасывает исключения во всех открытых функциях-членах и в деструкторе. Это сделано, чтобы можно было точно определить состояние логгера, возможность логирования при выбросе исключения из других классов. 
