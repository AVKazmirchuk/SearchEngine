...
- вызов функции "startInvertedIndexing". Разбивает прочитанные документы на группы. Количество групп равно количеству всех документов делённое на количество потоков (рассчитанное заранее) + 1 (если есть остаток),
  и рассчитывает для каждой группы базу инвертированного индекса.
