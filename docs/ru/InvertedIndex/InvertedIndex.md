...
##### Производительность:
Замеры времени рассчёта базы инвертированного индекса (обрабатывалось 843 документа, по 100'000 слов в каждом; 16-ти ядерный процессор):
...
Стоит отметить, что всё вышесказанное справедливо только для указанного количества документов и размера каждого документа. При других значениях время будет другое.
